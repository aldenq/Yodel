...
## Misc info:
  ...
  getting Yodel working on the internal WIFI interface google "patching raspberry pi wifi drivers for monitor mode and packet injection".I would reccomend buying  a cheap USB Dongle such as the one above.
